...
class AirportServer {
    ...
    private:
        ...
        static
    const int MAX_TAXI_TIME = 10; // Maximum time the airplane will occupy the requested runway after landing, in milliseconds
    static
    const int MAX_WAIT_TIME = 100; // Maximum time between landings, in milliseconds

    /**
    AirportServer.h Tue Apr 23 19:36:55 2019 2
    ...
    */
    ...
    /**
    * ***** Add declarations of your own Locks and Condition Variables
     here *****
    */
    std::mutex run15L;
    std::mutex run15R;
